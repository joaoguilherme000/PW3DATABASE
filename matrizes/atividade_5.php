...
echo "Utilizando vetores,  cadastre  10  pessoas, sendo  que  você  deverá  utilizar um vetor para  cadastrar  cada  pessoa.  Obtenha  seguintes  dados  do  usuário:  nome,  cidade, idade, sexo. Ao final do cadastro e armazenamento seu programa deverá exibir: <br/>";

echo " <br/> 4. E quantas pessoas cadastradas são do sexo masculino.";
...
// Listar nomes e idades
echo "<br/>";
echo "<br/> 1. Uma listagem de todos os nomes e idades das pessoas cadastradas";
echo "<br/>";
...
echo  "<br/>";
echo " <br/> 2. Uma listagem de todos os nomes de quem mora em Santos";
echo  "<br><br>";
...
echo  "<br>";
echo " <br/> 3. Uma listagem de todos os nomes de quem tem mais de 18 anos";
echo  " <br><br>";
