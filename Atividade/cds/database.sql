...
CREATE TABLE conjuge (
    ...
    primary key (cod_cli), -- Adjusted primary key
...
--  MEU CODIGO SEM ERROS, OS CODIGOS DO PDF TEM PEQUENOS ERROS --
-----------------------------------------------------------------
...
INSERT INTO dependentes (COD_DEP, COD_FUNC, NOME_DEP, SEXO_DEP) VALUES
(1, 1, 'ANA PEREIRA', 'F'),
...
(3, 4, 3, '2002-06-02', 100.00),
(4, 1, 4, '2003-02-02', 200.00),
...
-- OS DADOS INSERIDOS NO PDF DÃO ERRO --
----------------------------------------
INSERT INTO artistas (COD_ART, NOME_ART) VALUES
(1, 'MARISA MONTE'),
(2, 'GILBERTO GIL'),
...
INSERT INTO conjuge (COD_CLI, NOME_CONJ, RENDA_CLI, SEXO_CLI) VALUES
(1, 'CARLA NOGUEIRA', 2500.00, 'F'),
(2, 'EMILIA PEREIRA', 5500.00, 'F'),
(6, 'ALTIVA DA COSTA', 3000.00, 'F'),
(7, 'CARLOS DE SOUZA', 3250.00, 'M');
...
INSERT INTO pedidos (NUM_PED, COD_CID, COD_FUNC, DATA_PED, VAL_PED) VALUES
(1, 1, 2, '2002-05-02', 1500.00),
(2, 3, 4, '2002-05-02', 50.00),
(3, 4, 7, '2002-06-02', 100.00),
(4, 1, 4, '2003-02-02', 200.00),
(5, 7, 5, '2003-03-02', 300.00),
(6, 4, 4, '2003-03-02', 100.00),
(7, 5, 5, '2003-03-02', 50.00),
